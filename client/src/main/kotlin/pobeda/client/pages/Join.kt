...
//                +"В ближайшее время на указанную почту будет отправлен сертификат.
            ...
            styledForm(action = "", method = FormMethod.post) {
                ...
                styledP {
                    ...
                    + "Пожалуйста, проверьте, что все поля заполнены и загружен рисунок в формате jpg или png. При слишком долгой загрузке файла, перезагрузите страницу. При возникновении других проблем, обратитесь в службу поддержки сайта, указав возникшую проблему: risyem-pobedy@yandex.ru"
                }
            }
        }
    }
