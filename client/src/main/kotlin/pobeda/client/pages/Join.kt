...
//                +"В ближайшее время на указанную почту будет отправлен сертификат.
            ...
            styledForm(action = "", method = FormMethod.post) {
                ...
                styledP {
                    ...
                    + "Пожалуйста, проверьте, что все поля заполнены и загружен рисунок в формате jpg или png. При возникновении проблем, обратитесь в службу поддержки сайта, указав возникшую проблему и приложив скрины заполненной анкеты (верхней и нижней части): uhatov007@yandex.ru"
                }
            }
        }
    }
