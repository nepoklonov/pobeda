...
class HeaderComponent : RComponent<RoutedProps, RState>() {
    ...
    override fun RBuilder.render() {
        ...
        getDaysLeft().also {
            ...
            labelInBox(it.getPluralForm("день", "дня", "дней") + " осталось", 1066, 210, 1480, 280)
        }
        247.also {
